$(document).ready(function () {
   var i=1;
     ...
     $('#form2').on('click', '.btn', function(){
        ...
        $("#form2").append(texto);
        botones = '<div class="btn-group"><button class="btn waves-effect waves-light" type="submit" id="aceptar">Aceptar</button><button class="btn waves-effect waves-light" type="reset" id="cancelar">Cancelar</button></div>'
